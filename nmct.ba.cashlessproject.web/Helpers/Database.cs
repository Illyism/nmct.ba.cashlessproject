...
namespace nmct.ba.cashlessproject.web.Helpers
{
    class Database
    {
        ...
        public static ConnectionStringSettings CreateConnectionString(string database)
        {
            ConnectionStringSettings settings = new ConnectionStringSettings();
            settings.ProviderName = "System.Data.SqlClient";
            settings.ConnectionString = "Data Source=.;Initial Catalog=" + database + ";Integrated Security=True";
            return settings;
        }
        ...
        {
            return BuildCommand(GetConnection(ConnectionString), sql, parameters);
        }
        ...
        {
            return ModifyData(GetConnection(ConnectionString), sql, parameters);
        }
        ...
        {
            return InsertData(GetConnection(ConnectionString), sql, parameters);
        }
